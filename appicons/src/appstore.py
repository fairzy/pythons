...
#    try:
    ...
    for href in hrefs:
        ...
        # 再次app和tag的对应关系插入到表中
        apptag_table = Table( 'app_tag_ref_copy', metadata, autoload=True )
